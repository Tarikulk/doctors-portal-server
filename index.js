...
function sendBookingEmail(booking){
    ...
    //   });
      ...
      transporter.sendMail({
        from: "ullahtarik300@gmail.com",
        to: email || "ullahtarik300@gmail.com",
        subject: `Your appointment for ${treatment} is confirm`,
        text:"Hello World",
        html:`
        <h3>Your Appointment is confirmed</h3>
        <div>
        <>Your Appointment for treatment : ${treatment}<>
        <p>Please visit us on ${appointmentDate}</p> at ${slot}
...
async function run(){
    ...
    //    Note: make sure you use verification after jwt 
    ...
    //    temporary to update field on temporary options 
